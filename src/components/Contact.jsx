...
export default function Contact() {
  const contactInfo = [
    ...
    },
    {
      ...
      content: '+92 3149680045',
      link: 'tel:+923149680045'
    },
    {
      icon: '✉️',
      title: 'EMAIL ADDRESS',
    ...
    },
    {
      ...
      link: '/Muhammad_Wisal_Resume.pdf'
    }
  ]; 
  ...
  const socialLinks = [
    {
      name: 'LinkedIn',
      icon: 'linkedin',
      url: 'https://www.linkedin.com/in/muhammad-wisal-48792536b/',
...

    {
      name: 'Facebook',
      icon: 'facebook',
      url: 'https://www.facebook.com/profile.php?id=100042413143422',
      path: 'M9 8h-3v4h3v12h5v-12h3.642l.358-4h-4v-1.667c0-.955.192-1.333 1.115-1.333h2.885v-5h-3.808c-3.596 0-5.192 1.583-5.192 4.615v3.385z'
    },
    {
      name: 'Github',
      icon: 'github',
      url: 'https://github.com/WisalMomand',
